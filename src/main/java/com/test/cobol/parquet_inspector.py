...
root
 ...
 |    |    |-- upd_tsp_age: integer (nullable = true)
 |    |    |-- upd_tsp_days: integer (nullable = true)
 |-- cnfs: array (nullable = true)
 |    |-- element: struct (containsNull = true)
 |    |    |-- opt_out_flg: string (nullable = true)
 |    |    |-- cnsmr_stmt_flg: string (nullable = true)
 |    |    |-- dces_flg: string (nullable = true)
 |    |    |-- aka_tag: string (nullable = true)
 |    |    |-- empl_rec_cnt: integer (nullable = true)
 |    |    |-- pip_rec_cnt: integer (nullable = true)
 |    |    |-- armg_rec_cnt: integer (nullable = true)
 |    |    |-- cnst_rec_cnt: integer (nullable = true)
 |    |    |-- pubr_rec_cnt: integer (nullable = true)
 |    |    |-- cip_rec_cnt: integer (nullable = true)
 |    |    |-- padd_rec_cnt: integer (nullable = true)
 |    |    |-- trds_rec_cnt: integer (nullable = true)
 |    |    |-- coll_rec_cnt: integer (nullable = true)
 |    |    |-- nme_rec_cnt: integer (nullable = true)
 |    |    |-- tot_achi_dtl_cnt: integer (nullable = true)
 |    |    |-- aka_cnt: integer (nullable = true)
 |    |    |-- aka_manual_cnt: integer (nullable = true)
 |    |    |-- nip_rec_cnt: integer (nullable = true)
 ...
 |    |    |-- nme_pfx_cde: string (nullable = true)
 |    |    |-- frst_nme: string (nullable = true)
 |    |    |-- mdl_nme: string (nullable = true)
 |    |    |-- lst_nme: string (nullable = true)
 |    |    |-- full_nme: string (nullable = true)
 |    |    |-- genrtn_nme_sfx_cde: string (nullable = true)
 |    |    |-- salut_nme_sfx_cde: string (nullable = true)
 |    |    |-- birth_dte: date (nullable = true)
 |    |    |-- dces_dte: date (nullable = true)
 |    |    |-- soc_sec_num: string (nullable = true)
 |    |    |-- pre_dir_cde: string (nullable = true)
 |    |    |-- addr_num: string (nullable = true)
 |    |    |-- strt_nme: string (nullable = true)
 |    |    |-- strt_typ_cde: string (nullable = true)
 |    |    |-- post_dir_cde: string (nullable = true)
 |    |    |-- unt_typ_cde: string (nullable = true)
 |    |    |-- unt_num: string (nullable = true)
 |    |    |-- city_nme: string (nullable = true)
 |    |    |-- state_cde: string (nullable = true)
 |    |    |-- addr_line1_txt: string (nullable = true)
 |    |    |-- metro_area_zip_cde: string (nullable = true)
 |    |    |-- intra_area_zip_cde: string (nullable = true)
 |    |    |-- zip_cde: string (nullable = true)
 |    |    |-- zip_ext_cde: string (nullable = true)
 |    |    |-- addr_rpt_dte: date (nullable = true)
 |    |    |-- urb_nme: string (nullable = true)
